...
const Exams = () => {
  ...
  const currentExams = [
    { id: 1, title: "Math Midterm", date: "2025-09-10" },
    { id: 2, title: "Physics Quiz", date: "2025-09-15" },
  ];

  const pastExams = [
    { id: 3, title: "History Final", date: "2025-06-20" },
    { id: 4, title: "Chemistry Test", date: "2025-05-10" },
  ];

  const displayedExams = view === "current" ? currentExams : pastExams;
    ...
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn btn-outline rounded-xl flex items-center gap-2">
          ...
          displayedExams.map((exam) => (
            <div key={exam.id} className="card bg-white shadow-md rounded-2xl">
              <div className="card-body flex flex-row justify-between items-center p-4">
                <div>
                  <h2 className="card-title text-lg font-semibold">{exam.title}</h2>
